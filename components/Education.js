    ...
    <div className="border-t mt-16 pt-8 border-grayDetails text-lg text-grayText">
      ...
      <div className="flex flex-col pl-3 md:pl-0 md:flex-row w-full justify-between pt-20">
        <div>
          ...
          <p>San José de la Palabra de Dios</p>
          <span className="text-grayDetails text-sm mt-8 md:mt-16 block">
            2018
          </span>
          <p className="text-pink font-semibold mt-8">
            “Professional Webmaster” Course
          </p>
        ...
        <div className="">
          ...
          <p>FADU (Universidad de Buenos Aires)</p>
          <p className="text-pink font-semibold mt-8">
            UX/UI Design Certificate
          </p>
          <p>Coder House</p>
          <p className="font-semibold mt-8">UI Designer</p>
          <p>EGO Agency</p>
          <p className="font-semibold mt-8">UX/UI Designer</p>
          <p>Telintel</p>
          <p className="font-semibold mt-8">Free Lance UX/UI Designer</p>
          <p>PCKZ</p>
        </div>
      </div>
    </div>
